...
┌──(kali㉿kali)-[~/Downloads/keygenme-py]
└─$ ls
...
(c) Enter License Key
(d) Exit Arcane Calculator
What would you like to do, ANDERSON (a/b/c/d)? b
...
(c) Enter License Key
(d) Exit Arcane Calculator
What would you like to do, ANDERSON (a/b/c/d)? a 


SOL is detected as your nearest star.
To which system do you want to travel? Uv
